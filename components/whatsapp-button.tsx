...
export function WhatsAppButton({ locale }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      <button
        onClick={handleClick}
        className="flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white py-2 px-3 rounded-full shadow-lg transition-all text-sm whitespace-nowrap"
      ...
      >
        ...
        <span className="font-medium inline-block">{buttonText}</span>
      </button>
    </div>
  )
}
